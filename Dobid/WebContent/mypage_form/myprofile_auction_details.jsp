...
<!-- 헤더 -->
	...
	<div class="container">
		...
		<div class="panel panel-default row">
			...
			<div class="panel-body col-xs-8"><font color="red">${auctionlist.hot_check}</font><br>${auctionlist.title}<br>입찰가격 : ${auctionlist.bid_price_amount }원<br>종료일:  ${auctionlist.end_date}</div>
		</div>
		</c:forEach>
	</div>
