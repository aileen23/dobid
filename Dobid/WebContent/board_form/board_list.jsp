...
<body>
	...
	<div class="container">
		...
		<input type="button" class="button button5 btn-default active" value="공지사항" onclick="notice_board()"> 
		<input type="button" class="button button5 btn-default active" value="자유게시판" onclick="free_board()">
