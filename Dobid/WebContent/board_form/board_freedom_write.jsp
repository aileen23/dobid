...
<form class="form-horizontal">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-5">
      <input type="text" class="form-control" id="free_whiter_user" placeholder="작성자">
    </div>
  </div>
  <div class="form-group">
    <label for="inputWriter" class="col-sm-4 control-label">분류</label>
    <div class="col-sm-5">
      <select style="width: 100%" class="form-control" id="free_catalogue">
      	<option>분류1</option>
      	<option>분류2</option>
      	<option>분류3</option>
      	<option>분류4</option>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-5">
      <textarea class="form-control " id="free_contents" placeholder="내용을 입력하세요" style="height: 200px"></textarea>
    </div>
  </div>
 <div class="form-group">
    ...
    <div class="filebox col-sm-5">
        ...
        <input type="file" name="free_file" id="free_file" accept="image/*" capture="camera" onchange="getThumbnailPrivew(this,$('#free_img'))" />
        <br><br>
