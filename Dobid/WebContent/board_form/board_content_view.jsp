...
<form class="form-horizontal">
  <div class="form-group">
    ...
    <div class="col-sm-5">
      <input type="text" class="form-control" id="view_title" placeholder="제목">
    </div>
  </div>
  <div class="form-group">
    <label for="inputWriter" class="col-sm-4 control-label">작성자</label>
    <div class="col-sm-5">
      <input type="text" class="form-control" id="view_write_user" placeholder="작성자">
    </div>
  </div>
  <div class="form-group">
    <label for="inputWriter" class="col-sm-4 control-label">분류</label>
    <div class="col-sm-5">
      <select style="width: 100%" class="form-control" id="view_catalogue">
      	<option>분류1</option>
      	<option>분류2</option>
      	<option>분류3</option>
      	<option>분류4</option>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-5">
      <textarea class="form-control " id="view_contents" placeholder="입력된 내용" style="height: 200px"></textarea>
    </div>
  </div>
