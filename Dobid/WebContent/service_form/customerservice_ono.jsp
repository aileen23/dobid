...
<script src="service_form/js/customerservice_ono.js" type="text/javascript"></script> <!-- 유효성검사  --> 
<script src="service_form/js/customerservice_ono_upload.js" type="text/javascript"></script> <!-- 첨부파일 업로드  --> 
