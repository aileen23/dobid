...
<body>
  ...
  <div id="replyAdd" style="margin-top: 30px; border-top: 1px solid black;" >
     <form name="addForm">
        ...
        <input type="hidden" name="num" size="10" value="${noticeobject.basic_board_num }" style="display: ;" readonly="readonly">
  ...
  <div id="replyUpdate" style="display:none; margin: 10px;">
     <form name="updateForm">
       <input type="hidden" name="no">
       	 ...
       	 <input type="hidden" name="num" size="5" value="${noticeobject.basic_board_num }" style="display: ;" readonly="readonly">
