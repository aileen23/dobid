...
<form class="form-horizontal" style="margin-left: 25%">
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-default" style="margin-right: 10%">Sign in</button>  <button type="submit" class="btn btn-default" style="margin-right: 1%">Sign up</button>  <button type="submit" class="btn btn-default">Find ID/Password</button>
    </div>
  </div>
